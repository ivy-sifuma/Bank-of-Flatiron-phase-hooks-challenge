    ...
    <div className="ui segment">
      <form onSubmit={handleSubmitAction} onChange={handleChangeAction} className="ui form">
        <div className="inline fields">
          ...
          <input 
          value={formData.description} type="text" name="description" placeholder="Description" />
          <input 
          value={formData.category} type="text" name="category" placeholder="Category" />
          <input 
          value={formData.amount} type="number" name="amount" placeholder="Amount" step="0.01" />
        </div>
